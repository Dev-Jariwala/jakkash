              ...
              >
                <div className="relative">
                  <input
                    type="checkbox"
                    id="checkbox_input"
                    checked={formState.formData.addProducts}
                    onChange={() =>
                      setFormState((prev) => ({
                        ...prev,
                        formData: {
                          ...prev.formData,
                          addProducts: !prev.formData.addProducts,
                        },
                      }))
                    }
                    className="sr-only"
                  />
                  <div className="box mr-2 flex h-5 w-5 items-center justify-center rounded border-2 border-stroke dark:border-dark-3">
                    <span
                      className={`${
                        formState.formData.addProducts
                          ? "opacity-100"
                          : "opacity-0"
                      }`}
                    >
                ...
                Include '{activeColl.collectionName}' collection products?
              </label>
            </div>
