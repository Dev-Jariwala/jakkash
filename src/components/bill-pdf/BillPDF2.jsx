          ...
          <Page size="A5">
            <View style={styles.billContainer}>
                  ...
                  <View style={{ ...styles.bdRow, padding: "3px 10px" }}>
                    ...
                    >
                      ...
                      <View style={styles.bdRow}>
                        ...
                        <Text style={styles.bdCol}>{mobileNumber}</Text>
                      </View>
                    </View>
                    <View
                      style={{
              ...
              <View style={styles.notes}>
                ...
                <Text style={{ marginBottom: 2 }}>
                  * We will not be responsible for loss of Firki after delivery
                  date of Firki is late.
                </Text>
                <Text style={{ marginBottom: 2 }}>
                ...
                <Text style={{ marginBottom: 2 }}>
                  * If Firki is lost by us before the date of delivery, give
                  details of Firki in writing and take signature and take
                  delivery of Firki by 12 noon on 13th January.
                </Text>
                <Text style={{ marginBottom: 2 }}>
                  * If firki or bobbin is taken from us then payment will be
                  made first otherwise it will not be delivered.
                </Text>
                <Text style={{ marginBottom: 2 }}>
